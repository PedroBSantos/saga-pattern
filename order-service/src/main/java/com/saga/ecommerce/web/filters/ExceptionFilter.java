...
import com.saga.ecommerce.core.api.OrderNotFoundException;
...
public class ExceptionFilter extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorDto> onOrderNotFoundException(OrderNotFoundException exception, HttpServletRequest request) {
